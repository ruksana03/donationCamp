...
const AllFilteredDataCard = ({ displayData }) => {
    const { id, picture, view_image, title, card_category, card_category_bg, card_bg, text_color, description, price } = displayData || {};
    return (
...
export default AllFilteredDataCard;